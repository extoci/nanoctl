...
use nanoctl_update::{MAX_ARTIFACT_BYTES, validate_artifact};
pub use nanoctl_update::{UpdateArtifact, verify_for_current_target};
...
mod tests {
    ...
    use super::{UpdateArtifact, validate_download};
    #[cfg(unix)]
    use super::{activate_paths, rollback_paths};
    use nanoctl_update::verify_for_target;
